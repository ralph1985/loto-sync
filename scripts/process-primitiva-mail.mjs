...
function buildTextReport(result, group, dateLabel, balance, summary) {
  ...
  return [
    ...
    '',
    'Informe generado automáticamente por conquense.dev (https://conquense.dev) a partir del correo oficial de Loterías del Estado.'
  ].join('\n');
}
